 ...
 * <li>public void savePhotoOnDisk({@link org.telegram.telegrambots.spring.tg.action.TgPhotos} photos) {...}</li>
 * <li>public void playMusicLocally({@link org.telegram.telegrambots.api.objects.Audio} music) {...}</li>
 * </ul>
 * <br>
 * As a message comes to the {@link org.telegram.telegrambots.spring.tg.bot.TgMessageDispatcher} it gets dispatched to the next {@link org.telegram.telegrambots.spring.tg.action.TgAction} which then looks
 ...
 *
 * @author enoy19
 * @see org.telegram.telegrambots.spring.tg.action.TgActionRegisterer
 * @see TgParameterType
...
public @interface TgRequest {
	...
	/**
	 * @return the name of this request. If left as default {@link org.telegram.telegrambots.spring.tg.action.TgActionRegisterer} will use the method name
	 */
